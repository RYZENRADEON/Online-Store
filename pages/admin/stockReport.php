...
?>
    ...
    <head>
        ...
        <title>Admin Stock Report | Online Store</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            $rs = Database::search("SELECT * FROM `stock_details` ORDER BY `stock_id` ASC");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-end"><?php echo ("LKR " . $row["price"]); ?></td>
